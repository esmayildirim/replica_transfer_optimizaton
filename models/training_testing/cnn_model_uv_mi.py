...
def CNN_model_train(X_train,y_train, metric_name):
    ...
    checkpoint = ModelCheckpoint('cnn_best_weights_uv_mi_'+metric_name+"_"+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_CONV_LAYERS)+"_"+str(NUM_FILTERS)+'.h5',
                             monitor='val_loss',
                             verbose=1,
                             mode='min',
                             save_best_only=True)
    ...
    #plt.savefig('epocs_cnn_uv_mi_'+metric_name+"_"+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_CONV_LAYERS)+"_"+str(NUM_FILTERS)+'.eps', dpi = 300)
    #plt.close()
    return model
...
if __name__ == '__main__':
    ...
    #TESTING
    mae_list_BD, mape_list_BD, R2_BD = CNN_model_test_BD('cnn_best_weights_uv_mi_BD_'+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_CONV_LAYERS)+"_"+str(NUM_FILTERS)+'.h5', X_test_BD, y_test_BD)
    mae_list_TRL, mape_list_TRL, R2_TRL = CNN_model_test_TRL('cnn_best_weights_uv_mi_TRL_'+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_CONV_LAYERS)+"_"+str(NUM_FILTERS)+'.h5', X_test_TRL, y_test_TRL)
