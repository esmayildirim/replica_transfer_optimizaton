...
def CNN_model_train(X_train,y_train):
    ...
    checkpoint = ModelCheckpoint('cnn_best_weights_mv_mi_'+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_CONV_LAYERS)+"_"+str(NUM_FILTERS)+'.h5',
                             monitor='val_loss',
                             verbose=1,
                             mode='min',
                             save_best_only=True)
    ...
    #plt.savefig('epocs_cnn_mv_mi_'+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_CONV_LAYERS)+"_"+str(NUM_FILTERS)+'.eps', dpi = 300)
    #plt.close()
    return model
    
def CNN_model_test(checkpoint_filepath, X_test, y_test):
...
if __name__ == '__main__':
    ...
    model = CNN_model_train(X_train,y_train)

    mae_list, mape_list, R2 = CNN_model_test('cnn_best_weights_mv_mi_'+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_CONV_LAYERS)+"_"+str(NUM_FILTERS)+'.h5', X_test, y_test)
