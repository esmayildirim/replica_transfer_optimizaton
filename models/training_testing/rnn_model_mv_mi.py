...
def RNN_model_train(X_train,y_train):
    ...
    checkpoint = ModelCheckpoint('rnn_best_weights_mv_mi_'+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_RNN_LAYERS)+"_"+str(NUM_NODES)+'.h5',
                             monitor='val_loss',
                             verbose=1,
                             mode='min',
                             save_best_only=True)
    ...
    #plt.savefig('epocs'+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_RNN_LAYERS)+"_"+str(NUM_NODES)+'.eps', dpi = 300)
    #plt.close()
    return model
    
def RNN_model_test(checkpoint_filepath, X_test, y_test):
...
if __name__ == '__main__':
    ...
    #TRAINING
    model = RNN_model_train(X_train,y_train)
    #TESTING
    mae_list, mape_list, R2 = RNN_model_test('rnn_best_weights_mv_mi_'+str(NSTEPS_BACK)+"_"+str(NSTEPS_FUTURE)+"_layers"+str(NUM_RNN_LAYERS)+"_"+str(NUM_NODES)+'.h5', X_test, y_test)
